		...
		return new Promise((resolve) => {
			...
			if (this.isAmpProject || this.isAmpIframe) {
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=115630&cbuster=1711280082&pubUrl=https://emojipedia.org/taco&x=400&y=272&playerApiId=freestarPrimisPlayer&schain=1.0,1!freestar.com,1382,1&cbuster=1711248291',
					origQString: 's=115630&cbuster=1711280082&pubUrl=https://emojipedia.org/taco&x=400&y=272&playerApiId=freestarPrimisPlayer&schain=1.0,1!freestar.com,1382,1',
					placementId: 115630,
					x: 400,
					y: 272,
					videoType: 'normal',
					...
					searchMetaTagNames: {"tagAttribute":"name","tagName":"primis-category","relatedTagName":"primis-sub-category"},
